    ...
    return (
        <Modal isVisible={isVisible} onBackdropPress={onClose} style={styles.modal}>
            <View style={styles.modalContent}>
                <View style={{ backgroundColor: '#673AB7', borderRadius: 50, borderWidth: 2, borderColor: "#FFF", width: 60, height: 60, justifyContent: 'center', alignItems: 'center', position: 'absolute', top: -30, left: '48%' }}><Icon name='person' type="ionicon" size={40} color={"#FFF"} /></View>
